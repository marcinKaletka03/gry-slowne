...
public class BackgroundCloud extends Image {

    public BackgroundCloud(float scale) {
        super(new TextureRegion(RegionTextures.BG_CLOUDS.getRandom()));
    ...
    public void move(float time, float x, float y) {
        setZIndex(ScrableConfig.BG_CLOUD_INDEX);
